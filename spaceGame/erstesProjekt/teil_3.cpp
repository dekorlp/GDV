...
void RenderScene() //Zeichenfunktion
{
   ...
   gluLookAt(0., 0., 6., 0., 0., 0., 0., 1., 0.); // 1 Variante von Vorne
   // gluLookAt(0., 1., 1., 0., 0., 0., 0., 1., 0.); // 2 Variante von Vorne - Oben -> Backplane (2) musste um eins erhöht werden, weil durch die Position der Abstand größer wurde-> Satz des Pythagoras
    //gluLookAt(1., 0., 0., 0., 0., 0., 0., 1., 0.); // 2 Variante von rechts -> Backplane (1) genügt
